<template>
    <div>
        ...
        <meilele-lunbotu></meilele-lunbotu>
       
        <meilele-content></meilele-content>
        <meilele-fenye></meilele-fenye>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions([
                'getAllGoods','setmeilelepage','getgoods'
            ])
        ...
        created(){
            // this.getAllGoods()
            var that=this;
            this.setmeilelepage({meilelepage:'dengjutaocan',goodstype:'4'})
            // this.$nextTick(()=>{
            //     this.getgoods(1)
            // })
            setTimeout(function(){
                   that.getgoods({num:1,type:'4'})
               },500)
